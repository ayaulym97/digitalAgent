...
export default class ModalDropdown extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      showDropdown: false,
      buttonText: stringsoflanguages.getLanguage(),
  ...
  render() {
    console.log("modalBTNTXT", this.state.buttonText);
    return (
      <View {...this.props}>
        {this._renderButton()}
        {this._renderModal()}
  ...
  _renderButton() {
    ...
    console.log("BTNNNNN", buttonText);
    return (
      <TouchableOpacity
  ...
  _renderRow = (rowData, sectionID, rowID, highlightRow) => {
    ...
    const row = !renderRow ? (
      <View style={styles.button}>
        ...
        >
          {rowData === "ru" ? "Русский" : null}
          {rowData === "kz" ? "Қaзaқшa" : null}

          {rowData === "eng" ? "English" : null}
        </Text>
      </View>
    ) : (
  ...
  _onRowPress(rowData, sectionID, rowID, highlightRow) {
    ...
    stringsoflanguages.setLanguage(rowData);
    console.log("_onRowPress", rowData, stringsoflanguages.second);
  }
